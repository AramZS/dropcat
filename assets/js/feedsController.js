 ...
 * Controls all 
 */
dropCatApp.controller('feedsController', function ($scope, $location, $http, $interval) {
	...
	// Get the feed from a category by name
	$scope.getCatFeed = function() {
		console.log('get feed PressForward feeds');
		$http.get($scope.baseUrl+$scope.jsonEndPoint+$scope.postsEndPoint)
    		.success(function(response) 
    			{
